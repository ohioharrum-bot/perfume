        ...
        <div className="mx-auto max-w-6xl px-6 sm:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
            <div className="p-10 rounded-3xl bg-white shadow-sm border hover:-translate-y-1 hover:shadow-md transition-all">
              ...
              <h3 className="font-[var(--font-cormorant)] text-2xl font-semibold mb-4 text-gray-900">
                Discover
              </h3>
              <p className="font-[var(--font-lora)] text-lg leading-relaxed text-gray-700">
                Browse by brand, family, or notes to find what truly matches your
            ...
            <div className="p-10 rounded-3xl bg-white shadow-sm border hover:-translate-y-1 hover:shadow-md transition-all">
              ...
              <p className="font-[var(--font-lora)] text-lg leading-relaxed text-gray-700">
                Review verified listings side by side and find the right balance
                between price, quality, and authenticity.
              </p>
            </div>
            ...
            <div className="p-10 rounded-3xl bg-white shadow-sm border hover:-translate-y-1 hover:shadow-md transition-all">
              <div className="flex justify-center mb-6">
                ...
                >
                  <path
                    d="M10 42c7 3 12 0 15-2.5s5-3.5 8-1 3 3 6 3 4.5-1.5 6.5-1.5"
                    stroke="#000"
                    strokeLinecap="round"
              ...
              <p className="font-[var(--font-lora)] text-lg leading-relaxed text-gray-700">
                Select the scent that feels right for you, the one that reflects
                your mood and becomes part of your daily style.
              </p>
            </div>
          </div>
        </div>
